...
/// verme" senaryoları tam olarak burada kesiliyor. NewsService'te de bunun bir
/// eşi var — orada kesilen şey, yetkisi değişmiş kullanıcının içerik işlemleri.
///
...
///
/// NEDEN AYRI BİR DOĞRULAMA UCU DEĞİL: bu servis bir doğrulama ucu açıp diğer
/// servisler her istekte oraya sorsaydı, onların sıcak yolu bu servisin ayakta
/// olmasına bağlanırdı — ve burası çöktüğünde ya bütün site çöker ya da
/// korumayı kapatmak zorunda kalırız. Redis zaten ortak bağımlılık, anahtar
/// biçimi de Shared'da duruyor.
///
